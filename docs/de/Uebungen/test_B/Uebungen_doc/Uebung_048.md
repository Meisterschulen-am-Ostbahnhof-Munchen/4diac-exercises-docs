# Uebung_048: Reine Event-Schrittkette 4-Kanal ENDLOS

Dieser Artikel beschreibt die logiBUS®-Übung `Uebung_048`. Wir bauen eine rein ereignisgesteuerte Schrittkette.
...
Die Subapplikation `Uebung_048` nutzt den Sequenzer `sequence_E_04_loop`, der 4 Zustände rein ereignisgesteuert durchläuft.
