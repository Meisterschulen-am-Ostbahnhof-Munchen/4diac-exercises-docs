# Uebung_062: Reine Zeitsteuerung 5-Kanal

Dieser Artikel beschreibt die logiBUS®-Übung `Uebung_062`. Wir bauen eine rein zeitgesteuerte Schrittkette.
...
Die Subapplikation `Uebung_062` nutzt den Sequenzer `sequence_T_05`, der 5 Zustände (`S1` bis `S5`) rein zeitgesteuert durchläuft.

![Uebung_062_network](./Uebung_062_network.svg)

- **`sequence_T_05`**: Verwaltet die 5 Schritte, jeder Übergang erfolgt nach Ablauf der jeweiligen `DT_Sx_Sy`-Parameter.
