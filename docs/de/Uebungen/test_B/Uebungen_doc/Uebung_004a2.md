...
Die Subapplikation `Uebung_004a2.SUB` nutzt einen `E_MERGE` Baustein, um zwei Eingangs-Events auf einen gemeinsamen Takteingang zu leiten.
...
![Uebung_004a2_network](./Uebung_004a2_network.svg)
  ...
  - **`E_MERGE`**: Ein Standard-Ereignis-Baustein. Er besitzt zwei Ereigniseingänge (`EI1`, `EI2`) und einen Ereignisausgang (`EO`). Jedes eintreffende Event wird sofort an den Ausgang weitergereicht.
