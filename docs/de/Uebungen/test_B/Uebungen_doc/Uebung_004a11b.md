...
Dieser Artikel beschreibt die 4diac IDE Subapplikation Uebung_004a11b (Toggle Flip-Flop mit IE mit BUTTON_SINGLE_CLICK und STORE (NVS)).
...
Das Ziel dieser Übung ist die Umsetzung folgender Anforderung: **Toggle Flip-Flop mit IE mit BUTTON_SINGLE_CLICK und STORE (NVS)**

-----

## Beschreibung und Komponenten

Die Übung besteht aus der Subapplikation Uebung_004a11b.SUB, welche die folgende Bausteinstruktur verwendet:
...
- **INI_AX2**: Instanz des Typs logiBUS::storage::esp32_nvs::NVS_AX2.
  - Parameter QI = TRUE
...
Die Übung Uebung_004a11b demonstriert anschaulich die modulare IEC 61499 Architektur in 4diac IDE.
