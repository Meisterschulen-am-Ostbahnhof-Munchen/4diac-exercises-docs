# Uebung_058: Reine Event-Schrittkette 5-Kanal ENDLOS

Dieser Artikel beschreibt die logiBUS®-Übung `Uebung_058`. Wir bauen eine rein ereignisgesteuerte Schrittkette.
...
Die Subapplikation `Uebung_058` nutzt den Sequenzer `sequence_E_05_loop`, der 5 Zustände rein ereignisgesteuert durchläuft.
