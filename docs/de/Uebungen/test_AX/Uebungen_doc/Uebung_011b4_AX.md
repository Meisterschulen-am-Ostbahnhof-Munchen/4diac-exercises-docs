...
Dieser Artikel beschreibt die 4diac IDE Subapplikation Uebung_011b4_AX (Numeric Value Input SAFE_ADD).
...
Das Ziel dieser Übung ist die Umsetzung folgender Anforderung: **Numeric Value Input SAFE_ADD**

-----

## Beschreibung und Komponenten

Die Übung besteht aus der Subapplikation Uebung_011b4_AX.SUB, welche die folgende Bausteinstruktur verwendet:
...
- **SAFE_ADD_2**: Instanz des Typs SafeArithmetic::arithmetic::SAFE_ADD_2.
...
Die Übung Uebung_011b4_AX demonstriert anschaulich die modulare IEC 61499 Architektur in 4diac IDE.
