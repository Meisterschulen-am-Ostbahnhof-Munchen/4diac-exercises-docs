# Uebung_037_AX: Ablaufsteuerung 4-Kanal (Event & Zeit) ENDLOS (Adapter Version)

Dieser Artikel beschreibt die logiBUS®-Übung `Uebung_037_AX`. Wir bauen eine kombinierte Event- und Zeit-Schrittkette mit AX-Adaptertechnologie.
...
Die Subapplikation `Uebung_037_AX` nutzt den kombinierten Sequenzer `sequence_ET_04_loop_AX`.

![Uebung_037_AX_network](./Uebung_037_AX_network.svg)

- **`sequence_ET_04_loop_AX`**: Startet auf Ereignis (`I1`), schaltet die 4 Schritte danach zeitgesteuert weiter.
