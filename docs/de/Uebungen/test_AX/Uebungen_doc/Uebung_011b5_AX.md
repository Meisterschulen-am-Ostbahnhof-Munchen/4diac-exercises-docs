...
Dieser Artikel beschreibt die 4diac IDE Subapplikation Uebung_011b5_AX (Numeric Value Input SAFE_MUL).
...
Das Ziel dieser Übung ist die Umsetzung folgender Anforderung: **Numeric Value Input SAFE_MUL**

-----

## Beschreibung und Komponenten

Die Übung besteht aus der Subapplikation Uebung_011b5_AX.SUB, welche die folgende Bausteinstruktur verwendet:
...
- **SAFE_MUL_2**: Instanz des Typs SafeArithmetic::arithmetic::SAFE_MUL_2.
...
Die Übung Uebung_011b5_AX demonstriert anschaulich die modulare IEC 61499 Architektur in 4diac IDE.
