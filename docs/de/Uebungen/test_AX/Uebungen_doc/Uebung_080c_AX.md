...
Dieser Artikel beschreibt die 4diac IDE Subapplikation Uebung_080c_AX (Beispiel für E_CTU mit AX_T_FF und AX_PERMIT (Event-Halbierung) und Terminal-Ausgabe).
...
Das Ziel dieser Übung ist die Umsetzung folgender Anforderung: **Beispiel für E_CTU mit AX_T_FF und AX_PERMIT (Event-Halbierung) und Terminal-Ausgabe**

-----

## Beschreibung und Komponenten

Die Übung besteht aus der Subapplikation Uebung_080c_AX.SUB, welche die folgende Bausteinstruktur verwendet:
...
- **DigitalInput_CLK_I2**: Instanz des Typs logiBUS::io::DI::logiBUS_IE.
  ...
  - Parameter InputEvent = BUTTON_SINGLE_CLICK
- **AX_PERMIT**: Instanz des Typs adapter::events::unidirectional::AX_PERMIT.
...
Die Übung Uebung_080c_AX demonstriert anschaulich die modulare IEC 61499 Architektur in 4diac IDE.
