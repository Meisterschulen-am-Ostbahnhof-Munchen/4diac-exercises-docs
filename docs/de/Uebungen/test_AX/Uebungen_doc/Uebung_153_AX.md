...
Dieser Artikel beschreibt die 4diac IDE Subapplikation Uebung_153_AX (Impulszähler & PID Regler, mit Plug and Socket).
...
Das Ziel dieser Übung ist die Umsetzung folgender Anforderung: **Impulszähler & PID Regler, mit Plug and Socket**

-----

## Beschreibung und Komponenten

Die Übung besteht aus der Subapplikation Uebung_153_AX.SUB, welche die folgende Bausteinstruktur verwendet:
...
- **CTRL_PID**: Instanz des Typs OSCAT::Basic::POUs::Engineering::Control::CTRL_PID.
  - Parameter SET = 16.0
  - Parameter SUP = 0.0
  - Parameter OFS = 0.0
...
Die Übung Uebung_153_AX demonstriert anschaulich die modulare IEC 61499 Architektur in 4diac IDE.
