# Uebung_035a_AX: Reine Zeitsteuerung 4-Kanal (Adapter Version)

Dieser Artikel beschreibt die logiBUS®-Übung `Uebung_035a_AX`. Wir bauen eine rein zeitgesteuerte Schrittkette mit AX-Adaptertechnologie.
...
Die Subapplikation `Uebung_035a_AX` nutzt den Sequenzer `sequence_T_04_loop_AX` (AX-Adaptervariante), der 4 Zustände (`S1` bis `S4`) rein zeitgesteuert durchläuft.

![Uebung_035a_AX_network](./Uebung_035a_AX_network.svg)

- **`sequence_T_04_loop_AX`**: Verwaltet die 4 Schritte, jeder Übergang erfolgt nach Ablauf der jeweiligen `DT_Sx_Sy`-Parameter.
