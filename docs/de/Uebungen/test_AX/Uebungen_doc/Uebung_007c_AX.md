...
Dieser Artikel beschreibt die 4diac IDE Subapplikation Uebung_007c_AX (Blinker mit E_CYCLE und E_T_FF).
...
Die Übung besteht aus der Subapplikation Uebung_007c_AX.SUB, welche die folgende Bausteinstruktur verwendet:
...
- **E_SPLIT_3**: Instanz des Typs iec61499::events::E_SPLIT_3.
- **E_MERGE_3**: Instanz des Typs iec61499::events::E_MERGE_3.
...
Die Übung Uebung_007c_AX demonstriert anschaulich die modulare IEC 61499 Architektur in 4diac IDE.
