...
Dieser Artikel beschreibt die 4diac IDE Subapplikation Uebung_041_AX (Lauflicht 8 mit einer Taste, mit Plug and Socket).
...
Das Ziel dieser Übung ist die Umsetzung folgender Anforderung: **Lauflicht 8 mit einer Taste, mit Plug and Socket**

-----

## Beschreibung und Komponenten

Die Übung besteht aus der Subapplikation Uebung_041_AX.SUB, welche die folgende Bausteinstruktur verwendet:
...
- **AS_TO_AUDI**: Instanz des Typs adapter::conversion::unidirectional::AS_TO_AUDI.
...
- **DigitalInput_CLK_I2**: Instanz des Typs logiBUS::io::DI::logiBUS_IE.
  ...
  - Parameter InputEvent = BUTTON_SINGLE_CLICK
- **E_DEMUX_0**: Instanz des Typs adapter::events::unidirectional::AUI_DEMUX_8.
...
Die Übung Uebung_041_AX demonstriert anschaulich die modulare IEC 61499 Architektur in 4diac IDE.
