...
Dieser Artikel beschreibt die 4diac IDE Subapplikation Uebung_087_AX (Beispiel für E_DEMUX, mit Plug and Socket).
...
Das Ziel dieser Übung ist die Umsetzung folgender Anforderung: **Beispiel für E_DEMUX, mit Plug and Socket**

-----

## Beschreibung und Komponenten

Die Übung besteht aus der Subapplikation Uebung_087_AX.SUB, welche die folgende Bausteinstruktur verwendet:

### Verwendete Funktionsbausteine (FBs)

- **E_DEMUX**: Instanz des Typs iec61499::events::E_DEMUX.
...
Die Übung Uebung_087_AX demonstriert anschaulich die modulare IEC 61499 Architektur in 4diac IDE.
