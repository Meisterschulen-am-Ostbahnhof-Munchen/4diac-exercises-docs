...
Dieser Artikel beschreibt die 4diac IDE Subapplikation Uebung_056_AX (DigitalInput_I1-_I4 auf DigitalOutput_Q1-_Q4, mit Plug and Socket).
...
Die Übung besteht aus der Subapplikation Uebung_056_AX.SUB, welche die folgende Bausteinstruktur verwendet:
...
- **ASSEMBLE_BYTE_FROM_QUARTERS**: Instanz des Typs eclipse4diac::utils::assembling::ASSEMBLE_BYTE_FROM_QUARTERS.
...
- **SPLIT_BYTE_INTO_QUARTERS**: Instanz des Typs eclipse4diac::utils::splitting::SPLIT_BYTE_INTO_QUARTERS.
...
- **Q_TO_BOOL_Q1**: Instanz des Typs logiBUS::utils::quarter::QUARTER_TO_BOOL.
- **Q_TO_BOOL_Q4**: Instanz des Typs logiBUS::utils::quarter::QUARTER_TO_BOOL.
- **Q_TO_BOOL_Q2**: Instanz des Typs logiBUS::utils::quarter::QUARTER_TO_BOOL.
- **Q_TO_BOOL_Q3**: Instanz des Typs logiBUS::utils::quarter::QUARTER_TO_BOOL.
- **Q_TO_STR_STATUS_Q3**: Instanz des Typs logiBUS::utils::quarter::QUARTER_TO_STR_STATUS.
- **Q_TO_STR_STATUS_Q1**: Instanz des Typs logiBUS::utils::quarter::QUARTER_TO_STR_STATUS.
- **Q_TO_STR_STATUS_I3**: Instanz des Typs logiBUS::utils::quarter::QUARTER_TO_STR_STATUS.
- **Q_TO_STR_STATUS_I1**: Instanz des Typs logiBUS::utils::quarter::QUARTER_TO_STR_STATUS.
- **Q_TO_STR_STATUS_I4**: Instanz des Typs logiBUS::utils::quarter::QUARTER_TO_STR_STATUS.
- **Q_TO_STR_STATUS_Q4**: Instanz des Typs logiBUS::utils::quarter::QUARTER_TO_STR_STATUS.
- **Q_TO_STR_STATUS_Q2**: Instanz des Typs logiBUS::utils::quarter::QUARTER_TO_STR_STATUS.
- **Q_TO_STR_STATUS_I2**: Instanz des Typs logiBUS::utils::quarter::QUARTER_TO_STR_STATUS.
- **BOOL_TO_Q_I1**: Instanz des Typs logiBUS::utils::quarter::BOOL_TO_QUARTER.
- **BOOL_TO_Q_I2**: Instanz des Typs logiBUS::utils::quarter::BOOL_TO_QUARTER.
- **BOOL_TO_Q_I4**: Instanz des Typs logiBUS::utils::quarter::BOOL_TO_QUARTER.
- **BOOL_TO_Q_I3**: Instanz des Typs logiBUS::utils::quarter::BOOL_TO_QUARTER.
...
Die Übung Uebung_056_AX demonstriert anschaulich die modulare IEC 61499 Architektur in 4diac IDE.
