...
Dieser Artikel beschreibt die 4diac IDE Subapplikation Uebung_122b_AX (Übung zu ISOBUS Name).
...
Die Übung besteht aus der Subapplikation Uebung_122b_AX.SUB, welche die folgende Bausteinstruktur verwendet:
...
- **LOG_16B**: Instanz des Typs logiBUS::utils::logging::LOG_16.
...
- **SD_B_1**: Instanz des Typs eclipse4diac::convert::STRUCT_DEMUX.
- **SD_B_2**: Instanz des Typs eclipse4diac::convert::STRUCT_DEMUX.
- **SD_B_3**: Instanz des Typs eclipse4diac::convert::STRUCT_DEMUX.
- **SD_B_4**: Instanz des Typs eclipse4diac::convert::STRUCT_DEMUX.
- **SD_B_5**: Instanz des Typs eclipse4diac::convert::STRUCT_DEMUX.
- **SD_B_6**: Instanz des Typs eclipse4diac::convert::STRUCT_DEMUX.
- **SD_B_7**: Instanz des Typs eclipse4diac::convert::STRUCT_DEMUX.
- **SD_B_8**: Instanz des Typs eclipse4diac::convert::STRUCT_DEMUX.
- **SD_B_9**: Instanz des Typs eclipse4diac::convert::STRUCT_DEMUX.
- **SD_B_10**: Instanz des Typs eclipse4diac::convert::STRUCT_DEMUX.
- **SD_B_11**: Instanz des Typs eclipse4diac::convert::STRUCT_DEMUX.
- **SD_B_12**: Instanz des Typs eclipse4diac::convert::STRUCT_DEMUX.
- **SD_B_13**: Instanz des Typs eclipse4diac::convert::STRUCT_DEMUX.
- **SD_B_14**: Instanz des Typs eclipse4diac::convert::STRUCT_DEMUX.
- **SD_B_15**: Instanz des Typs eclipse4diac::convert::STRUCT_DEMUX.
- **SD_B_16**: Instanz des Typs eclipse4diac::convert::STRUCT_DEMUX.
...
Die Übung Uebung_122b_AX demonstriert anschaulich die modulare IEC 61499 Architektur in 4diac IDE.
