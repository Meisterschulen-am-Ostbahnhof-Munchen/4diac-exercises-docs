...
Dieser Artikel beschreibt die 4diac IDE Subapplikation Uebung_011b3_PHYS_AX (Numeric Value Input SUB (PHYS)).
...
Das Ziel dieser Übung ist die Umsetzung folgender Anforderung: **Numeric Value Input SUB (PHYS)**

-----

## Beschreibung und Komponenten

Die Übung besteht aus der Subapplikation Uebung_011b3_PHYS_AX.SUB, welche die folgende Bausteinstruktur verwendet:
...
- **AR_SUB_2**: Instanz des Typs adapter::iec61131::arithmetic::AR_SUB_2.
...
Die Übung Uebung_011b3_PHYS_AX demonstriert anschaulich die modulare IEC 61499 Architektur in 4diac IDE.
