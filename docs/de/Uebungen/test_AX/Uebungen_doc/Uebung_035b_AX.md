...
Dieser Artikel beschreibt die 4diac IDE Subapplikation Uebung_035b_AX (Spiegelabfolge V2 mit Schrittkette).
...
Die Übung besteht aus der Subapplikation Uebung_035b_AX.SUB, welche die folgende Bausteinstruktur verwendet:
...
- **E_RTimeOut**: Instanz des Typs iec61499::events::E_RTimeOut.
...
Die Übung Uebung_035b_AX demonstriert anschaulich die modulare IEC 61499 Architektur in 4diac IDE.
