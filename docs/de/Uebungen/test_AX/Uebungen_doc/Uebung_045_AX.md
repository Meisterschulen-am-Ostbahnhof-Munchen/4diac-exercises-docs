# Uebung_045_AX: Ablaufsteuerung 8-Kanal (Event & Zeit) (Adapter Version)

Dieser Artikel beschreibt die logiBUS®-Übung `Uebung_045_AX`. Wir bauen eine kombinierte Event- und Zeit-Schrittkette mit AX-Adaptertechnologie.
...
Die Subapplikation `Uebung_045_AX` nutzt den kombinierten Sequenzer `sequence_ET_08_AX`.

![Uebung_045_AX_network](./Uebung_045_AX_network.svg)

- **`sequence_ET_08_AX`**: Startet auf Ereignis (`I1`), schaltet die 8 Schritte danach zeitgesteuert weiter.
