...
Dieser Artikel beschreibt die 4diac IDE Subapplikation Uebung_007d4_AX (Random Generator mit FB_AR_RANDOM, AR_D_FF_HYS_TMIN, initval_AR und AR_GT auf DigitalOutput_Q1).
...
Das Ziel dieser Übung ist die Umsetzung folgender Anforderung: **Random Generator mit FB_AR_RANDOM, AR_D_FF_HYS_TMIN, initval_AR und AR_GT auf DigitalOutput_Q1**

-----

## Beschreibung und Komponenten

Die Übung besteht aus der Subapplikation Uebung_007d4_AX.SUB, welche die folgende Bausteinstruktur verwendet:
...
- **FB_AR_RANDOM**: Instanz des Typs adapter::utils::FB_AR_RANDOM.
  - Parameter SEED = 0
- **AR_D_FF_HYS_TMIN**: Instanz des Typs adapter::events::unidirectional::AR_D_FF_HYS_TMIN.
...
Die Übung Uebung_007d4_AX demonstriert anschaulich die modulare IEC 61499 Architektur in 4diac IDE.
