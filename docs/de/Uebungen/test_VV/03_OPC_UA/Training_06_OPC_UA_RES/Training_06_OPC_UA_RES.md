...
[`Bibliotheken/ExternalLibraries/adapter`](https://meisterschulen-am-ostbahnhof-munchen-docs.readthedocs.io/projects/4diac-library-reference-docs-de/en/latest/ExternalLibraries/adapter/)).
