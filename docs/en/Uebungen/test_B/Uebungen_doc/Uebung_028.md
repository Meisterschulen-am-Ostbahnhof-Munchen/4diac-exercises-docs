...
The sub-application `Uebung_028.SUB` reads two analog channels from the hardware.

### Function Blocks (FBs)

![Uebung_028_network](./Uebung_028_network.svg)

- **`AnalogInput_I4` & `I7`**: Type `logiBUS_AI_ID`. These blocks represent the analog hardware inputs. They convert the electrical voltage into a numerical digital value.
