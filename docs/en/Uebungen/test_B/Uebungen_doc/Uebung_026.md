...
In this exercise, the complex sequence logic from Exercise 025 is retained, but the control of the hardware outputs is outsourced to a typed sub-application `Uebung_026_sub`.
