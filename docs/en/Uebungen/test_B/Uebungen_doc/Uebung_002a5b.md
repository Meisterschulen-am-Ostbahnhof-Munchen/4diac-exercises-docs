...
In the subapplication `Uebung_002a5b.SUB`, three input blocks are linked to three output blocks via an OR gate.

### Function Blocks (FBs)

![Uebung_002a5b_network](./Uebung_002a5b_network.svg)

- **`DigitalInput_I1` to `I3`**: Three instances of type `logiBUS_IX`. They monitor the hardware inputs `Input_I1`, `Input_I2`, and `Input_I3`.
