...
directly motivated the [SafeArithmetic](https://meisterschulen-am-ostbahnhof-munchen-docs.readthedocs.io/projects/4diac-library-reference-docs-de/en/latest/ExternalLibraries/SafeArithmetic/)
library and its [SAFE_SUB](https://meisterschulen-am-ostbahnhof-munchen-docs.readthedocs.io/projects/4diac-library-reference-docs-de/en/latest/ExternalLibraries/SafeArithmetic/arithmetic/SAFE_SUB/)
