...
network, using
[SAFE_MUL_2](https://meisterschulen-am-ostbahnhof-munchen-docs.readthedocs.io/projects/4diac-library-reference-docs-en/en/latest/ExternalLibraries/SafeArithmetic/arithmetic/SAFE_MUL_2/)
