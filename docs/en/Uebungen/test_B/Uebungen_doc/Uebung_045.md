# Uebung_045: Combined Event/Time Sequence Control, 8 Channels

This article describes the logiBUS® exercise `Uebung_045`. We build a combined event- and time-driven step chain.
...
The subapplication `Uebung_045` uses the combined sequencer `sequence_ET_08`.

![Uebung_045_network](./Uebung_045_network.svg)

- **`sequence_ET_08`**: Starts on an event (`I1`), then advances the 8 steps on elapsed time.
