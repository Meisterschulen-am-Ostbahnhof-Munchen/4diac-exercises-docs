...
The subapplication `Uebung_003b.SUB` uses four instances of type `Uebung_003b_sub` (identical to `Uebung_003a_sub`) to link four I/O pairs.

### Typed Subapplication: `Uebung_003b_sub`

This component encapsulates the one-to-one routing from a digital input (`IX`) to a digital output (`QX`). It provides two configuration parameters:
