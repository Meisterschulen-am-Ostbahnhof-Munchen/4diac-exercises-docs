...
### Sub-block: [logiBUS_IXA_BG_OPC](https://meisterschulen-am-ostbahnhof-munchen-docs.readthedocs.io/projects/4diac-library-reference-docs-en/en/latest/ExternalLibraries/MyLib_AX/sys/logiBUS_IXA_BG_OPC/) (inputs)
