...
This article describes the 4diac IDE sub-application Uebung_011a_AX (Numeric Value Output und BUTTON_PRESS_REPEAT_DONE).
...
The exercise consists of the sub-application Uebung_011a_AX.SUB, which uses the following function block structure:

### Instantiated Function Blocks (FBs)

- **Q_NumericValue**: Instance of type isobus::UT::Q::Q_NumericValue_AUDI.
  - Parameter u16ObjId = OutputNumber_N1
- **logiBUS_IB**: Instance of type logiBUS::io::DI::logiBUS_IBA.
  - Parameter QI = TRUE
  - Parameter Input = Input_I1
  - Parameter InputEvent = BUTTON_PRESS_REPEAT_DONE
- **F_BYTE_TO_UDINT**: Instance of type adapter::conversion::unidirectional::AB_TO_AUDI.
...
Exercise Uebung_011a_AX provides a clear demonstration of modular IEC 61499 application design in 4diac IDE.
