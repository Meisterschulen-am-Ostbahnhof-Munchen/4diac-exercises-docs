...
This article describes the 4diac IDE sub-application Uebung_080b_AX (Beispiel für E_CTU mit AX_SPLIT_2 für Event-Verdoppelung und Terminal-Ausgabe).
...
The main objective of this exercise is to implement the following requirement: **Beispiel für E_CTU mit AX_SPLIT_2 für Event-Verdoppelung und Terminal-Ausgabe**

-----

## Description and Components

The exercise consists of the sub-application Uebung_080b_AX.SUB, which uses the following function block structure:
...
- **DigitalInput_CLK_I2**: Instance of type logiBUS::io::DI::logiBUS_IE.
  ...
  - Parameter InputEvent = BUTTON_SINGLE_CLICK
- **E_SPLIT**: Instance of type iec61499::events::E_SPLIT.
...
Exercise Uebung_080b_AX provides a clear demonstration of modular IEC 61499 application design in 4diac IDE.
