...
This article describes the 4diac IDE sub-application Uebung_011b6_AX (Numeric Value Input SAFE_SUB).
...
The main objective of this exercise is to implement the following requirement: **Numeric Value Input SAFE_SUB**

-----

## Description and Components

The exercise consists of the sub-application Uebung_011b6_AX.SUB, which uses the following function block structure:
...
- **SAFE_SUB**: Instance of type SafeArithmetic::arithmetic::SAFE_SUB.
...
Exercise Uebung_011b6_AX provides a clear demonstration of modular IEC 61499 application design in 4diac IDE.
