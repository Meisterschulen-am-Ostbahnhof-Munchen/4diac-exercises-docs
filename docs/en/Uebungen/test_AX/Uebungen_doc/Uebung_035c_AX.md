...
This article describes the 4diac IDE sub-application Uebung_035c_AX (Spiegelabfolge V2 mit Schrittkette).
...
The exercise consists of the sub-application Uebung_035c_AX.SUB, which uses the following function block structure:
...
Exercise Uebung_035c_AX provides a clear demonstration of modular IEC 61499 application design in 4diac IDE.
