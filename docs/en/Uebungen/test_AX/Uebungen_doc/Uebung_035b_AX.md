# Uebung_035b_AX: Spiegelabfolge V2 mit Schrittkette

This article describes the 4diac IDE sub-application Uebung_035b_AX (Spiegelabfolge V2 mit Schrittkette).

----

![Uebung_035b_AX_network](./Uebung_035b_AX_network.svg)
...
The exercise consists of the sub-application Uebung_035b_AX.SUB, which uses the following function block structure:
...
- **E_RTimeOut**: Instance of type iec61499::events::E_RTimeOut.
...
> TODO!
das soll da Beispiel mit E_RT werden, das funktioniert aber noch nicht.
...
Exercise Uebung_035b_AX provides a clear demonstration of modular IEC 61499 application design in 4diac IDE.
