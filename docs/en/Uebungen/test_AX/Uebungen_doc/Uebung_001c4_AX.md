...
The exercise consists of the sub-application Uebung_001c4_AX.SUB, which uses the following function block structure:
...
Exercise Uebung_001c4_AX provides a clear demonstration of modular IEC 61499 application design in 4diac IDE.
