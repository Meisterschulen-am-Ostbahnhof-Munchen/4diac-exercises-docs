...
This article describes the 4diac IDE sub-application Uebung_080e_AX (Beispiel für E_CTU mit Eventbremse durch E_D_FF_ANY).
...
The exercise consists of the sub-application Uebung_080e_AX.SUB, which uses the following function block structure:
...
Exercise Uebung_080e_AX provides a clear demonstration of modular IEC 61499 application design in 4diac IDE.
