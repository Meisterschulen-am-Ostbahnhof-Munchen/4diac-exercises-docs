# Uebung_041_AX: Lauflicht 8 mit einer Taste, mit Plug and Socket

This article describes the 4diac IDE sub-application Uebung_041_AX (Lauflicht 8 mit einer Taste, mit Plug and Socket).

----

![Uebung_041_AX_network](./Uebung_041_AX_network.svg)

## Objective of the Exercise

The main objective of this exercise is to implement the following requirement: **Lauflicht 8 mit einer Taste, mit Plug and Socket**

-----

## Description and Components

The exercise consists of the sub-application Uebung_041_AX.SUB, which uses the following function block structure:
...
- **AS_TO_AUDI**: Instance of type adapter::conversion::unidirectional::AS_TO_AUDI.
...
- **DigitalInput_CLK_I2**: Instance of type logiBUS::io::DI::logiBUS_IE.
  ...
  - Parameter InputEvent = BUTTON_SINGLE_CLICK
- **E_DEMUX_0**: Instance of type adapter::events::unidirectional::AUI_DEMUX_8.
...
- loop.STATE_NR -> AS_TO_AUDI.AS_IN
- AS_TO_AUDI.AUDI_OUT -> Q_NumericValue.u32NewValue
...
- E_DEMUX_0.EO5 -> loop.S5_S6
- E_DEMUX_0.EO6 -> loop.S6_S7
- E_DEMUX_0.EO7 -> loop.S7_S8
- E_DEMUX_0.EO8 -> loop.S8_S1
- E_DEMUX_0.EO8 -> E_CTU_0.R
...
Exercise Uebung_041_AX provides a clear demonstration of modular IEC 61499 application design in 4diac IDE.
