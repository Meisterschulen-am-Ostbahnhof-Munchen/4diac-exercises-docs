# Uebung_126b2_AX: Übung zu ISOBUS Send Message Cyclic (mit CB) SINUS-Funktion Plotten

This article describes the 4diac IDE sub-application Uebung_126b2_AX (Übung zu ISOBUS Send Message Cyclic (mit CB) SINUS-Funktion Plotten).

----

![Uebung_126b2_AX_network](./Uebung_126b2_AX_network.svg)
...
The exercise consists of the sub-application Uebung_126b2_AX.SUB, which uses the following function block structure:
...
Exercise Uebung_126b2_AX provides a clear demonstration of modular IEC 61499 application design in 4diac IDE.
