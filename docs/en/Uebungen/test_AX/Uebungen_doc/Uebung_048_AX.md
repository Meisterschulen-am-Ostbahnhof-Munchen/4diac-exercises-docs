# Uebung_048_AX: Pure Event-Driven Step Chain, 4 Channels (Loop) (Adapter Version)

This article describes the logiBUS® exercise `Uebung_048_AX`. We build a purely event-driven step chain using AX adapter technology.
...
The subapplication `Uebung_048_AX` uses the sequencer `sequence_E_04_loop_AX`, which cycles through 4 states purely event-driven.
