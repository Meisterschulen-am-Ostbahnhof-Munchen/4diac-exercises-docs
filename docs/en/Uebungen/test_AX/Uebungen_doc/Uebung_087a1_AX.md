...
This article describes the 4diac IDE sub-application Uebung_087a1_AX (Beispiel für E_DEMUX_4, mit Plug and Socket).
...
The exercise consists of the sub-application Uebung_087a1_AX.SUB, which uses the following function block structure:
...
Exercise Uebung_087a1_AX provides a clear demonstration of modular IEC 61499 application design in 4diac IDE.
