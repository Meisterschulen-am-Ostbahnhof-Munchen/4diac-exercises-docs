...
This article describes the 4diac IDE sub-application Uebung_054_AX (DigitalInput_I1-_I4 auf DigitalOutput_Q1-_Q4, mit Plug and Socket).
...
The exercise consists of the sub-application Uebung_054_AX.SUB, which uses the following function block structure:
...
- **ARR08B_TO_BOOLS**: Instance of type logiBUS::utils::conversion::arr::forwarding::ARR08X_TO_BOOLS.
- **BOOLS_TO_ARR08B**: Instance of type logiBUS::utils::conversion::arr::reversing::BOOLS_TO_ARR08X.
...
Exercise Uebung_054_AX provides a clear demonstration of modular IEC 61499 application design in 4diac IDE.
