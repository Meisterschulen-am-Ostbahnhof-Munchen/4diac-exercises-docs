...
This article describes the 4diac IDE sub-application Uebung_122_AX (Übung zu ISOBUS Name).
...
The exercise consists of the sub-application Uebung_122_AX.SUB, which uses the following function block structure:
...
Exercise Uebung_122_AX provides a clear demonstration of modular IEC 61499 application design in 4diac IDE.
