...
This article describes the 4diac IDE sub-application Uebung_018a_AX (Control Audio Signal und Delay).
...
The exercise consists of the sub-application Uebung_018a_AX.SUB, which uses the following function block structure:
...
- **Q_CtrlAudioSignal_1**: Instance of type isobus::UT::Q::Q_CtrlAudioSignal.
  ...
  - Parameter u16OnTimeMs = 150
  - Parameter u16OffTimeMs = 0
- **E_RDELAY**: Instance of type iec61499::events::E_RDELAY.
...
Exercise Uebung_018a_AX provides a clear demonstration of modular IEC 61499 application design in 4diac IDE.
