# Uebung_130_AX: Übung zu ISOBUS Receive Message

This article describes the 4diac IDE sub-application Uebung_130_AX (Übung zu ISOBUS Receive Message).

----

![Uebung_130_AX_network](./Uebung_130_AX_network.svg)
...
The exercise consists of the sub-application Uebung_130_AX.SUB, which uses the following function block structure:
...
Exercise Uebung_130_AX provides a clear demonstration of modular IEC 61499 application design in 4diac IDE.
