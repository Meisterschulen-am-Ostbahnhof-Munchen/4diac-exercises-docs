# Uebung_011b5_AX: Numeric Value Input SAFE_MUL

This article describes the 4diac IDE sub-application Uebung_011b5_AX (Numeric Value Input SAFE_MUL).

----

![Uebung_011b5_AX_network](./Uebung_011b5_AX_network.svg)

## Objective of the Exercise

The main objective of this exercise is to implement the following requirement: **Numeric Value Input SAFE_MUL**

-----

## Description and Components

The exercise consists of the sub-application Uebung_011b5_AX.SUB, which uses the following function block structure:
...
- **SAFE_MUL_2**: Instance of type SafeArithmetic::arithmetic::SAFE_MUL_2.
...
- F_DWORD_TO_UDINT_1.CNF -> SAFE_MUL_2.REQ
- SAFE_MUL_2.CNF -> Q_NumericValue.REQ
- SAFE_MUL_2.CNF -> F_BOOL_TO_UDINT.REQ
...
- F_DWORD_TO_UDINT_1.OUT -> SAFE_MUL_2.IN2
- SAFE_MUL_2.OUT -> Q_NumericValue.u32NewValue
- SAFE_MUL_2.LIMIT_HIT -> F_BOOL_TO_UDINT.IN
...
Exercise Uebung_011b5_AX provides a clear demonstration of modular IEC 61499 application design in 4diac IDE.
