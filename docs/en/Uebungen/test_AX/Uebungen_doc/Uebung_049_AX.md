...
This article describes the 4diac IDE sub-application Uebung_049_AX (DigitalInput_I1-_I4 auf DigitalOutput_Q1-_Q4, mit Plug and Socket).
...
The exercise consists of the sub-application Uebung_049_AX.SUB, which uses the following function block structure:
...
Exercise Uebung_049_AX provides a clear demonstration of modular IEC 61499 application design in 4diac IDE.
