...
This article describes the 4diac IDE sub-application Uebung_011b1_PHYS_AX (Numeric Value Input ADD (PHYS)).
...
The main objective of this exercise is to implement the following requirement: **Numeric Value Input ADD (PHYS)**

-----

## Description and Components

The exercise consists of the sub-application Uebung_011b1_PHYS_AX.SUB, which uses the following function block structure:
...
- **AR_ADD_2**: Instance of type adapter::iec61131::arithmetic::AR_ADD_2.
...
Exercise Uebung_011b1_PHYS_AX provides a clear demonstration of modular IEC 61499 application design in 4diac IDE.
