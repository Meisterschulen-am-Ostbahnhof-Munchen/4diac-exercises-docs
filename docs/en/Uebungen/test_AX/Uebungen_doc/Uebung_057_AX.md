# Uebung_057_AX: Pure Event-Driven Step Chain, 5 Channels (Adapter Version)

This article describes the logiBUS® exercise `Uebung_057_AX`. We build a purely event-driven step chain using AX adapter technology.
...
The subapplication `Uebung_057_AX` uses the sequencer `sequence_E_05_AX`, which cycles through 5 states purely event-driven.
