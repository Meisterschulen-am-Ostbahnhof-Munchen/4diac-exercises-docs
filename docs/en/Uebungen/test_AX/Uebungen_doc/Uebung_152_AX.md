...
This article describes the 4diac IDE sub-application Uebung_152_AX (Impulszähler & PI Regler, mit Plug and Socket).
...
The main objective of this exercise is to implement the following requirement: **Impulszähler & PI Regler, mit Plug and Socket**

-----

## Description and Components

The exercise consists of the sub-application Uebung_152_AX.SUB, which uses the following function block structure:
...
- **CTRL_PI**: Instance of type OSCAT::Basic::POUs::Engineering::Control::CTRL_PI.
  - Parameter SET = 16.0
  - Parameter SUP = 0.0
  - Parameter OFS = 0.0
...
Exercise Uebung_152_AX provides a clear demonstration of modular IEC 61499 application design in 4diac IDE.
