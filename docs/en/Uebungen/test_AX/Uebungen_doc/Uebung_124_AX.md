# Uebung_124_AX: Übung zu ISOBUS Send Message

This article describes the 4diac IDE sub-application Uebung_124_AX (Übung zu ISOBUS Send Message).

----

![Uebung_124_AX_network](./Uebung_124_AX_network.svg)

## Objective of the Exercise

The main objective of this exercise is to implement the following requirement: **Übung zu ISOBUS Send Message**

-----

## Description and Components

The exercise consists of the sub-application Uebung_124_AX.SUB, which uses the following function block structure:
...
- NmGetCfInfo_1.IND -> AlPgnTxNew8B.install
...
- NmGetCfInfo_1.sNetEv -> AlPgnTxNew8B.NmDestin
...
Exercise Uebung_124_AX provides a clear demonstration of modular IEC 61499 application design in 4diac IDE.
